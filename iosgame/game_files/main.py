...
class RootWidget(BoxLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.bg_music = SoundLoader.load("audio/mainmenu.wav")

        if(self.bg_music):
            self.bg_music.loop = True
            self.bg_music.play()

        self.sound_explosion = SoundLoader.load("audio/sounds/explosiontemp.wav")
    ...
    def update_timer(self, dt):
        ...
        if self.seconds >= 59:
            ...
            self.player.reset_update_round()

            self.rocket_control.reset_update_round()
